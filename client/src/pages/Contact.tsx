        ...
        <div className="container mx-auto px-6 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-3xl mx-auto">
              ...
              sur IzyInbox et vous accompagner dans votre projet.
            </p>
          </div>
        </div>
      </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <ContactInfoCard
                  ...
                  title="Email"
                  info="hello@izyinbox.fr"
                  subInfo="Réponse sous 24h"
                  action="mailto:hello@izyinbox.fr"
                />
                <ContactInfoCard
            ...
            <div className="bg-accent/20 rounded-md p-6">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">Sous 24h en semaine</div>
                </div>
              </div>
              <p className="text-sm text-muted-foreground">
                Notre équipe s'engage à vous répondre dans les meilleurs délais. 
                Vos données sont traitées en toute confidentialité (RGPD).
              </p>
            </div>
          </div>
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
                ...
                <div className="bg-accent/20 rounded-md p-4 text-sm text-muted-foreground">
                  ...
                  Vos données sont traitées de manière confidentielle et sécurisée (RGPD).
                </div>
