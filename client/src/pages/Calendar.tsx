          ...
          {viewMode === "week" && (
            <Card>
              <CardContent className="p-2 md:p-4 overflow-hidden">
                ...
                <div className="grid gap-0.5 md:gap-1 sticky top-0 z-50 bg-card mb-1 md:mb-2 overflow-x-auto" style={{ gridTemplateColumns: "30px md:60px repeat(7, 1fr)" }}>
                  <div className="font-semibold text-xs text-center p-1 md:p-2 whitespace-nowrap">Heure</div>
                  {getWeekDays().map((day, idx) => (
                    <div
                      key={day.toISOString()}
                      className={`font-semibold text-xs text-center p-1 md:p-2 rounded border-r border-dashed border-border whitespace-nowrap ${
                ...
                <div className="overflow-x-auto -mx-2 md:mx-0">
                  <div className="px-2 md:px-0 inline-block min-w-full">
                    <div className="grid gap-0.5 md:gap-1" style={{ gridTemplateColumns: "30px md:60px repeat(7, 1fr)" }}>
                      {/* Hours and appointments */}
                      {getHours().map((hour) => (
                        <div key={`row-${hour}`} className="contents">
                          <div className="text-xs text-muted-foreground text-center p-1 md:p-2 border-t whitespace-nowrap">
