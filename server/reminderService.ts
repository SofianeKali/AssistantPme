        ...
        try {
          ...
          for (const email of emails) {
            ...
            try {
              ...
              if (sent) {
                result.sent++;
                console.log(`[Reminders] Sent quote reminder #${reminderNumber} for company ${company.id}, email: ${email.id}`);
              } else {
                result.errors++;
          ...
          console.error(`[Reminders] Error checking quote reminders for company ${company.id}:`, companyError);
          result.errors++;
        }
      }
    } catch (error) {
        ...
        try {
          ...
          for (const email of emails) {
            ...
            try {
              ...
              if (sent) {
                result.sent++;
                console.log(`[Reminders] Sent invoice reminder #${reminderNumber} for company ${company.id}, email: ${email.id}`);
              } else {
                result.errors++;
          ...
          console.error(`[Reminders] Error checking invoice reminders for company ${company.id}:`, companyError);
          result.errors++;
        }
      }
    } catch (error) {
